...
//  FILE NAME: Cube.cpp
//
//	Please see Lab08.pdf for details
//  =============================================================================
...
void loadTextures()
{
    glGenTextures(2, tex);   //Generate 2 texture IDs
...
void initialise()
{
	...
	GLuint texLoc0 = glGetUniformLocation(program, "tSampler1");  //tSampler1 is a uniform variable of type Sampler2D in the fragment shader
	glUniform1i(texLoc0, 0);    //Assign a value 0 to the variable tSampler1 to specify that it should use the texture from unit 0.

	GLuint texLoc1 = glGetUniformLocation(program, "tSampler2");
