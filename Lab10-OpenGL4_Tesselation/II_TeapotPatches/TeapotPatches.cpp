...
void display()
{
	...
	if (camDist <= 50 && camDist > 46) {
		level = 3;
	} else if (camDist <= 46 && camDist > 42) {
		level = 4;
	}
	else if (camDist <= 42 && camDist > 38) {
		level = 5;
	}
	else if (camDist <= 38 && camDist > 34) {
		level = 6;
	}
	else if (camDist <= 34 && camDist > 30) {
		level = 7;
	}
	else if (camDist <= 30 && camDist > 24) {
		level = 8;
	}
	else if (camDist <= 24 && camDist > 20) {
		level = 9;
	}
	else if (camDist <= 20 && camDist > 16) {
		level = 10;
	}
	else if (camDist <= 16 && camDist > 12) {
		level = 11;
	}
	else if (camDist <= 12 && camDist > 10) {
		level = 12;
	}
